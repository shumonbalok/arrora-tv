...
<head>
    ...
    <link href="{{asset('css/vue-validate/snow.css')}}" rel='stylesheet' type='text/css' media="all" />
...
<body>
            ...
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <h1><img src="{{asset('images/logo.png')}}" alt="Arroratube" /></h1>
                    </a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <div class="header-top-right">
                        ...
                        @else
                        <div class="file">
                            <a href="{{route('channels.uploadvideo', auth()->user()->channel->id)}}">Upload</a>
                        </div>
                        <div class="signin">
                    ...
                    <div class="footer-top">
                        <div class="footer-top-nav">
                            <ul>
                                ...
                                <li><a href="{{route('developers')}}">Creators</a></li>
                        ...
                        <div class="footer-bottom-nav">
                            <ul>
                                ...
                                <li><a href="{{route('privecy')}}">Privacy</a></li>
                                <li><a href="#small-dialog4" class="play-icon popup-with-zoom-anim">Send feedback</a>
                                </li>
                                <li><a href="{{route('privecy')}}">Policy & Safety </a></li>
                                <li><a href="{{route('about')}}">Try something new!</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="footer-bottom">
                        <ul>
                            ...
                            <li><a href="#small-dialog5"
                                    class="play-icon popup-with-zoom-anim f-history f-help">Help</a>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <!-- Scripts -->
    <script>
        __authCheck = '{{ auth()->check() }}';
    @auth
        __auth = JSON.parse('{!! auth()->check() ? auth()->user() : null !!}');
    @endauth
    </script>
